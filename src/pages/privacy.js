...
const Privacy = () => (
  <Layout>
    <Seo title="Privacy Policy" location="/privacy" />
    <Wrapper>
      <main>
        <LogoWrapper>
          <Link to="/">
        ...
        <h1>Cookie Policy for Your Dev Guy</h1>

        <p>This is the Cookie Policy for Your Dev Guy, accessible from https://www.yourdevguy.com</p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              site actually make a purchase and as such this is the kind of data that these cookies will track. This is
              important to you as it means that we can accurately make business predictions that allow us to monitor our
        ...
        <ul>
          <li>Email: info@yourdevguy.com</li>
        </ul>
      </main>
    </Wrapper>
  </Layout>
